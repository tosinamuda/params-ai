export function Footer() {
  return (
    <footer className="w-full  py-10 px-4 sm:px-6 lg:px-8 bg-violet-100">
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500">
            An Human-LLM Research Project part of AI Research & Development Team
          </p>
          <p className="text-gray-500">
            © Entropy. 2023 Tosin Amuda. All rights reserved.
          </p>
        </div>
